...
function createDemoProjectModal() {
  if (stateManager.projects.length === 0) {
    ...
    message.textContent =
      "Would you like to load a demo project to assist in demonstration?";
    ...
    yesButton.textContent = "Yes, load demo project";
...
function addMetaDemoProject() {
  ...
  const readmeTask = new Task(meta.id, "Write README", "", "2025-03-30", "Low");
...
export const demoProject = { createDemoProjectModal };
